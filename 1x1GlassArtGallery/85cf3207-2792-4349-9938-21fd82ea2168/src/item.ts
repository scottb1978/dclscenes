...
export default class Lamp implements IScript<Props> {
  clip = new AudioClip('85cf3207-2792-4349-9938-21fd82ea2168/sounds/Click.mp3')
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    let offModel = new GLTFShape('85cf3207-2792-4349-9938-21fd82ea2168/models/RainLight_Off.glb')
    lampOff.addComponent(offModel)

    const lampOn = new Entity(host.name + '-on')
    lampOn.setParent(host)
    lampOn.addComponent(new Transform())
    let onModel = new GLTFShape('85cf3207-2792-4349-9938-21fd82ea2168/models/RainLight_On.glb')
